...
tell application "System Events" 
    ...
    before giving the answers, you must correct my grammar or recommend the common native English with every sentence(ignore case error), remember, correct my sentence for every sentence. if my sentence does not need to optimize, please say 'Your Sentence is correct.'.  So, My first request is: 
"
